...
struct MeloDicerExpander : Module {
    ...
    MeloDicerExpander() {
        ...
        // Configure semitone CV inputs and attenuverters
        for (int i = 0; i < 12; i++) {
        ...
        // Configure octave low CV input and attenuverter
        ...
        // Configure octave high CV input and attenuverter
    ...
    // The expander's process method is not used as the main module directly accesses its inputs and parameters.
    // This keeps CPU usage minimal within the expander itself.
