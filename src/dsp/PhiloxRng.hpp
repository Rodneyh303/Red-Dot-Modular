...
namespace seed {
    ...
    // q-mix / source-select: its OWN Philox stream (S+3), decorrelated from rhythm/melody/CA
    // so "which notes" (q-mix) varies independently of "where they interleave" (melody).
