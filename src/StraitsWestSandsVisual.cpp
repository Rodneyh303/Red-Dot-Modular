...
namespace StraitsWestVisualIds {
    enum ParamId {
        SPREAD_V0_R = 0, SPREAD_V0_M, SPREAD_V0_O,   // Voice 9
        SPREAD_V1_R,     SPREAD_V1_M, SPREAD_V1_O,   // Voice 10
        SPREAD_V2_R,     SPREAD_V2_M, SPREAD_V2_O,   // Voice 11
        SPREAD_V3_R,     SPREAD_V3_M, SPREAD_V3_O,   // Voice 12
        SPREAD_V4_R,     SPREAD_V4_M, SPREAD_V4_O,   // Voice 13
        SPREAD_V5_R,     SPREAD_V5_M, SPREAD_V5_O,   // Voice 14
        SPREAD_V6_R,     SPREAD_V6_M, SPREAD_V6_O,   // Voice 15
        SPREAD_V7_R,     SPREAD_V7_M, SPREAD_V7_O,   // Voice 16
        INTERP_TARGET,
        NUM_PARAMS
    };
...
struct StraitsWestSandsVisualWidget : ModuleWidget {
    ...
    explicit StraitsWestSandsVisualWidget(StraitsWestSandsVisual* mod) {
        ...
        tabGroup = new TabButtonGroup(8, /*startVoiceNum=*/9,
                                      mm2px(12.f), mm2px(8.f), mm2px(1.f));
        ...
        paramMgr = new PolyVoiceSandsParameterManager(nullptr, nullptr, 8, 0);
    }
