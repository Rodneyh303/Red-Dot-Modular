...
// One alias per file in res/knobs/: redDot::<Palette>_<Size>_<Style>.
// See res/knobs/README.md for palettes (measured contrast), sizes (footprints are
