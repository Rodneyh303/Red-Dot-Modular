...
def gen_macro(dark, W_MM=243.84):   # 48HP (44 + 4HP for dir_mod + prob_out jack columns)
    ...
    LANE_H=12.; ED_LANES=5; ED_H=ED_LANES*LANE_H   # 60 (Option A)
    ED_LANE_H=LANE_H
    ...
    A(D.helix_sands(4.0, 78.0, 74.0, 35.0, t, op=0.95))   # Option A: editor shorter, helix stays higher   # Sands Helix hero mark, bottom-left pocket (moved down 6mm so its MBS motif reads lower; wordmark moved the same amount)
    ...
    BLEND_TOP=76.0; BLEND_H=47.0; BGAP=2.5; GROUP_W=ED_W/4.0  # 4 groups; taller for the tap row 3
...
def gen_mono(dark):
    ...
    ROW_TOP,LANE_H,N=14.,12.,7   # Option A: 12mm keeps the 14..98 box unchanged
